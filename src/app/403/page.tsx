...
export default function ForbiddenPage() {
	...
	return (
		<div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden px-6 py-12 selection:bg-slate-900 selection:text-white">
